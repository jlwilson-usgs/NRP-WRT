...
# NJ_source_df = NJ_source_df.groupby('id').first()
# NJ_source_df.reset_index(inplace=True)
...
# MD_source_df = MD_source_df.groupby('id').first()
# MD_source_df.reset_index(inplace=True)
...
# ID_source_df = ID_source_df.groupby('id').first()
# ID_source_df.reset_index(inplace=True)
